...
class ContactView(ModelView):
    """
    View model class contact for the admin panel
    """
    can_delete = False
    can_edit = True
    can_create = True
    ...
    def _list_thumbnail(view, context, model, name):
        ...
        url = url_for('static', filename=os.path.join('images/contact/', model.image))
    ...
    form_extra_fields = {
        ...
        "image": form.ImageUploadField(
            '',
            base_path=os.path.join(file_path, 'portfolioapp/static/images/contact/'),
    ...
    def create_form(self, obj=None):
        ...
        app.logger.warning(msg='create form contact')
        return super(ContactView, self).create_form(obj)

    def edit_form(self, obj=None):
        from wsgi import app
        app.logger.warning(msg='edit form contact')
