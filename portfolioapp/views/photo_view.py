...
class PhotoView(ModelView):
    """
    View model class photo for the admin panel
    """
    can_delete = True
    can_edit = True
    can_create = True
    ...
    def _list_thumbnail(view, context, model, name):
        ...
        url = url_for('static', filename=os.path.join('images/home/photo', model.image))
    ...
    form_extra_fields = {
        ...
        "image": form.ImageUploadField(
            '',
            base_path=os.path.join(file_path, 'portfolioapp/static/images/home/photo'),
    ...
    def create_form(self, obj=None):
        ...
        app.logger.warning(msg='create form photo')
        return super(PhotoView, self).create_form(obj)

    def edit_form(self, obj=None):
        from wsgi import app
        app.logger.warning(msg='edit form photo')
        return super(PhotoView, self).edit_form(obj)
